$(function() {
  ...
  if ( $(window).width() < 1199 ) {
   //Скролл на табах
    ...
    $('.princ__btn').on('click', function(){
      $('html, body').animate({
          scrollTop: $("#princ__content").offset().top - 50
      }, 700);
    });
    ...
    $('.part__item-wrp').removeClass('col-xl-3 col-sm-6');
    ...
    $('.rec__item-wrp').removeClass('col-xl-3 col-sm-6');
    $('.rec__in').owlCarousel({
      nav: true,
      // items: 2,
      loop: true,
